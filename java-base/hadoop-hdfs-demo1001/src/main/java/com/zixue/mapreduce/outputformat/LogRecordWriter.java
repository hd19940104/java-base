package com.zixue.mapreduce.outputformat;
...
public class LogRecordWriter extends RecordWriter<Text, NullWritable> {
    ...
    public LogRecordWriter(TaskAttemptContext job) {
        ...
        try {
            ...
            Path atguiguPath = new Path("C:\\Users\\houdo\\Desktop\\test.txt");
            Path otherPath = new Path("C:\\Users\\houdo\\Desktop\\other.txt");
            //  输出流
