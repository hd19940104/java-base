...
public class ExportExcelUtil {
	...
	public void expoerDataExcel(HttpServletResponse response, ArrayList<String> titleKeyList,
			Map<String, String> titleMap, List<Map<String, Object>> src_list) throws IOException {

		String xlsFile_name = "Result-" + new SimpleDateFormat("yyyyMMddhhmmss").format(new Date()) + ".xlsx"; // 输出xls文件名称
		// 内存中只创建100个对象
